<?php
class WC_MoneyTigoPnfTwo extends WC_Payment_Gateway {
  /**
   * Construction of MoneyTigo two-step payment method
   *
   * @return void
   */
  public function __construct() {
    ...
    $this->method_title = __( 'MoneyTigo - Payment in two instalments', 'moneytigo' );

    // Define user set variables.
    $this->title = $this->settings[ 'title' ];
    $this->instructions = $this->get_option( 'instructions' );
    $this->method_description = __( 'Accept payment in two instalments! <a href="https://app.moneytigo.com/user/register">Open an account now !</a>', 'moneytigo' );
...
public function init_form_fields() {
  ...
  $this->form_fields = array(
    'enabled' => array(
      ...
      'type' => 'checkbox',
      'label' => __( 'Activate payment in two instalments', 'moneytigo' ),

    ),
    'seuil' => array(
      'title' => __( 'Minimum amount', 'moneytigo' ),
      'type' => 'text',
      'label' => __( 'Indicate the minimum amount of the cart to be able to use this payment method (Minimum 50 EUR)', 'moneytigo' ),
      'desc_tip' => __( 'Define from which amount you want your customer to be able to use this payment method.', 'moneytigo' ),
      'default' => '50'
    ),
    'title' => array(
      ...
      'desc_tip' => true,
      'default' => __( 'Credit card in two instalments', 'moneytigo' )
    ),
    'description' => array(
