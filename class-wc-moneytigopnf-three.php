...
class WC_MoneyTigoPnfThree extends WC_Payment_Gateway {
  ...
  public function __construct() {
    ...
    $this->method_title = __( 'MoneyTigo - Payment in three instalments', 'moneytigo' );

    // Define user set variables.
    $this->title = $this->settings[ 'title' ];
    $this->instructions = $this->get_option( 'instructions' );
    $this->method_description = __( 'Accept payment in three instalments! <a href="https://app.moneytigo.com/user/register">Open an account now !</a>', 'moneytigo' );
...
public function init_form_fields() {
  ...
  $this->form_fields = array(
    'enabled' => array(
      ...
      'type' => 'checkbox',
      'label' => __( 'Activate payment in three instalments', 'moneytigo' ),
    ...
    'title' => array(
      ...
      'desc_tip' => true,
      'default' => __( 'Credit card in three instalments', 'moneytigo' )
    ),
    'description' => array(
