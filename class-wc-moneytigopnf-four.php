...
class WC_MoneyTigoPnfFour extends WC_Payment_Gateway {
  ...
  public function __construct() {
    ...
    $this->method_title = __( 'MoneyTigo - Payment in four instalments', 'moneytigo_woocommerce' );

    // Define user set variables.
    $this->title = $this->settings[ 'title' ];
    $this->instructions = $this->get_option( 'instructions' );
    $this->method_description = __( 'Accept payment in four instalments! <a href="https://app.moneytigo.com/user/register">Open an account now !</a>', 'moneytigo_woocommerce' );
...
public function init_form_fields() {
  ...
  $this->form_fields = array(
    'enabled' => array(
      ...
      'type' => 'checkbox',
      'label' => __( 'Activate payment in four instalments', 'moneytigo_woocommerce' ),
    ...
    'title' => array(
      ...
      'desc_tip' => true,
      'default' => __( 'Credit card in four instalments', 'moneytigo_woocommerce' )
    ),
    'description' => array(
